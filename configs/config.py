...
model = dict(
    ...
    generator=dict(
        ...
        cpu_cache_length=200,  # 100
        sf=(5,4,4),
        interpolation_mode='slomo',
        slomo_pretrained='/home/kaist/ETRI_ksp/cluster/SuperSloMo.ckpt',
...
data_dir = '/home/ksp/ksp/DAVSR/data'
data = dict(
    workers_per_gpu=8,
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder=f'{data_dir}/REDS_mmedit/train/train_blur_bicubic/X4',
            # gt_folder=f'{data_dir}/REDS_mmedit/train_orig',
            gt_folder=f'{data_dir}/REDS_mmedit/train/train_orig',
            num_input_frames=5,
    ...
    val=dict(
        ...
        lq_folder=f'{data_dir}/REDS_mmedit/test/test_blur_bicubic/X4',
        # gt_folder=f'{data_dir}/testset_REDS4_original_HR/',
        gt_folder=f'{data_dir}/REDS_mmedit/test/test_orig',
        num_input_frames=5,
...
evaluation = dict(interval=300000, save_image=False, gpu_collect=True) #   remove gpu_collect if not use dist train
log_config = dict(
    interval=100,
    hooks=[
...
# run_dir = './work_dirs'
# run_dir = './work_dirs_gshift'
run_dir = './work_dirs_vsr2'
